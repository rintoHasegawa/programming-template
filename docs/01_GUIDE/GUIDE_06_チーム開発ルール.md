...
- 進捗・タスクは GitHub Issues と git 履歴で追う．`CLAUDE.md` には進捗を書かない（この点は GUIDE_05 の進捗記録ルールを**上書き**する）．
...
`CLAUDE.md` と `.claude/`（agents・commands・hooks・settings.json）は全員の Claude の挙動を決める共有インフラである．
